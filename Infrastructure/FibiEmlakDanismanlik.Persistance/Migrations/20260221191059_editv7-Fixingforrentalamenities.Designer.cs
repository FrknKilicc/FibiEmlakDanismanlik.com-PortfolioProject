...
namespace FibiEmlakDanismanlik.Persistence.Migrations
{
    ...
    [Migration("20260221191059_editv7-Fixingforrentalamenities")]
    partial class editv7Fixingforrentalamenities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FibiEmlakDanismanlik.Domain.Entities.RentalCommercialListingAmenities", b =>
                {
                    ...
                    b.Property<int?>("RentalCommercialPropertyListingRentalCommercialListId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RentalCommercialPropertyListingRentalCommercialListId");
            ...
            modelBuilder.Entity("FibiEmlakDanismanlik.Domain.Entities.RentalHousingListingAmenities", b =>
                {
                    ...
                    b.Property<int>("AmenityDefinitionAmenityId")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("RentalHousingListingRentalHousingListId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("AmenityDefinitionAmenityId");

                    b.HasIndex("RentalHousingListingRentalHousingListId");
            ...
            modelBuilder.Entity("FibiEmlakDanismanlik.Domain.Entities.RentalLandListingAmenities", b =>
                {
                    ...
                    b.Property<int>("RentalLandListId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FibiEmlakDanismanlik.Domain.Entities.RentalCommercialListingAmenities", b =>
                {
                    ...
                    b.HasOne("FibiEmlakDanismanlik.Domain.Entities.RentalCommercialPropertyListing", null)
                        .WithMany("Amenities")
                        .HasForeignKey("RentalCommercialPropertyListingRentalCommercialListId");
            ...
            modelBuilder.Entity("FibiEmlakDanismanlik.Domain.Entities.RentalHousingListingAmenities", b =>
                {
                    b.HasOne("FibiEmlakDanismanlik.Domain.Entities.AmenityDefinition", "AmenityDefinition")
                        .WithMany()
                        .HasForeignKey("AmenityDefinitionAmenityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FibiEmlakDanismanlik.Domain.Entities.RentalHousingListing", "RentalHousingListing")
                        .WithMany()
                        .HasForeignKey("RentalHousingListingRentalHousingListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
