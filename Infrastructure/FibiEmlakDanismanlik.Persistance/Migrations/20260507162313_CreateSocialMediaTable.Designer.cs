...
namespace FibiEmlakDanismanlik.Persistence.Migrations
{
    ...
    [Migration("20260507162313_CreateSocialMediaTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FibiEmlakDanismanlik.Domain.Entities.BlogCategory", b =>
                {
                    b.Property<int>("BlogCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FibiEmlakDanismanlik.Domain.Entities.ListingGeoPoint", b =>
                {
                    b.Property<int>("ListingGeoPointId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ListingGeoPointId"));
                    ...
                    b.HasKey("ListingGeoPointId");

                    b.HasIndex("ListingId", "ListingTypeId")
                        .IsUnique();

                    b.ToTable("ListingGeoPoints");
                });

            modelBuilder.Entity("FibiEmlakDanismanlik.Domain.Entities.ListingImageSelection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ListingId", "SectionKey", "ImageNo")
                        .IsUnique();

                    b.ToTable("ListingImageSelections");
                });

            modelBuilder.Entity("FibiEmlakDanismanlik.Domain.Entities.ListingNearbyPlace", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FibiEmlakDanismanlik.Domain.Entities.NearbyCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FibiEmlakDanismanlik.Domain.Entities.SocialMedia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FibiEmlakDanismanlik.Domain.Entities.Blog", b =>
                {
                    ...
                    b.HasOne("FibiEmlakDanismanlik.Domain.Entities.BlogCategory", "BlogCategory")
                        .WithMany("Blogs")
            ...
            modelBuilder.Entity("FibiEmlakDanismanlik.Domain.Entities.ListingNearbyPlace", b =>
                {
                    b.HasOne("FibiEmlakDanismanlik.Domain.Entities.NearbyCategory", "NearbyCategory")
                        .WithMany("Places")
                        .HasForeignKey("NearbyCategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("NearbyCategory");
                });
