...
{
    public class GetFilteredForSalePropertiesForListingQueryHandler : IRequestHandler<GetFilteredForSalePropertiesForListingQuery, List<GetAllForSalePropertiesForListingResult>>
    {
        ...
        public async Task<List<GetAllForSalePropertiesForListingResult>> Handle(
