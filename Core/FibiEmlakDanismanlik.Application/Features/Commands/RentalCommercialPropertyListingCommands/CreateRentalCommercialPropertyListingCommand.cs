...
namespace FibiEmlakDanismanlik.Application.Features.Commands.RentalCommercialPropertyListingCommands
{
    public class CreateRentalCommercialPropertyListingCommand:IRequest
    {
