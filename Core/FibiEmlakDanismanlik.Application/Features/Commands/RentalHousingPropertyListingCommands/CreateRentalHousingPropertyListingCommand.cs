...
namespace FibiEmlakDanismanlik.Application.Features.Commands.RentalHousingPropertyListingCommands
{
    public class CreateRentalHousingPropertyListingCommand : IRequest
    {
